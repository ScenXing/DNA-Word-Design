...
#	+ Compute and return a BINARY (k1, k4)-distance matrix M (consisting of
#	  characters '0' and '1') of dimension n x l
#
# Input description:
...
def genbinword14sub(n, l, k1, k4, pascalprefixsum):
	...
	Inputs:
	 ...
	 + pascalprefixsum: is a 2D array with at least l + 1 rows. Row i has (i + 1) entries. pascalprefixsum[i][j] = sum ( i Choose h ) for h = 0, ..., j.
...
#	+ Compute and return the (k1, k4)-distance matrix M (consisting of
#	  characters '0' and '1').
...
######################################################################################
# gendnaword1to6(n, maptypetoparam):ex
#	+ Generate and return a set of DNA words satisfying C1 to C6 constraints.
#
# Input specfication:
#	+ n: the number of strings to generate
#	+ maptypetoparam: a dictionary that maps an integer (representing
...
#	+ Generate and return a set of DNA words satisfying C1 to C7 constraints.
#
# Input specfication:
#	+ n: the number of strings to generate
#	+ maptypetoparam: a dictionary that maps an integer (representing
...
#	+ Generate and return a set of DNA words satisfying C1, C2, C3
...
#	+ Generate and return a set of DNA words satisfying C1 to C8 constraints.
#
# Input specfication:
#	+ n: the number of strings to generate
#	+ maptypetoparam: a dictionary that maps an integer (representing
...
def gendnaword1to6and9generic(n, maptypetoparam, construct_bounded_energy_dna):
	...
	Inputs:
	 ...
	 + construct_bounded_energy_dna: a function to generate a list of string with specified length and that has free energy bounded between the specified interval.
