...
##############################################################################
# count_assigned_pos(str1, start1, end1, str2, start2, end2, unkownchar):
#	+ Return the pair of value (s, t) where
#		s = the number of positions k in the substrings str1[start1 ... end1] and
#	            str2[start2 ... end2] such that str1[k] and str2[k] are not unknown
#		t = the number of positions k in the substrings str1[start1 ... end1] and
#	            str2[start2 ... end2] such that str1[k] and str2[k] are not unknown and
#		    str1[k] != str2[k]
#	+ Throws an exception if the substrings str1[start1 ... end1] and str2[start2 ... end2]
